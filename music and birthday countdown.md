...
const div1 =  (
	<div style={{display:"flex",whiteSpace:"pre-wrap",textAlign: 'center'}}>
		<div style={{flex: 1}}>
			<p><b>Music of the Month</b></p>
			<iframe  style={div3Style}  src="https://music.163.com/outchain/player?type=2&id=1901371647&auto=1&height=66"></iframe>
		</div>
